        ...
        try {
            ...
            if (response) {
                ...
                const updatedResponse = {
                    ...response,
                    Pallet_label_imagen: base64Data.value
                };
                emit('pallet-label-updated', updatedResponse);
            } else {
...
<template>
    ...
    <div v-else class="modal fade" id="PalletLabelImagen" tabindex="-1" aria-labelledby="PalletLabelImagenlabel" aria-hidden="true">
    <div class="upload-modal-container  modal-dialog modal-content">
        <div class="modal-body">
            ...
            <div class="title-upload">
                <h2 class="font-24 MuseoSemiBold">{{ $t('Wouldyoulike')}} dfsdfsdf</h2>
            </div>
